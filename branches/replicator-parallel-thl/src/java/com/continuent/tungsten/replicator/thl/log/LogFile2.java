 ...
 * write from the underlying file.  This is the old version of LogFile, which 
 * is preserved in order to test compatibility. 
 * 
...
public class LogFile2
{
     ...
     */
    public LogFile2(File parentDirectory, String fileName)
    {
